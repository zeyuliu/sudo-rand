...
//  indDiv = new float[N*N];
  ...
  neval = 0;
  rawSum = rawAve = rawDev = rawVar = rawMax = rawMin = 0.0F;
  fitSum = fitAve = fitDev = fitVar = fitMax = fitMin = 0.0F;
  popDiv = -1.0F;
...
GAPopulation::statistics(GABoolean flag) const {
  ...
  if(n > 0) {
    ...
    This->rawMin = This->rawMax = This->rawSum = 0.0F;
    This->rawDev = This->rawVar = 0.0F;
  }
...
GAPopulation::scale(GABoolean flag) const {
  ...
  if(n > 0) {
    ...
    This->fitMin = This->fitMax = This->fitSum = 0.0F;
    This->fitVar = This->fitDev = 0.0F;
  }
