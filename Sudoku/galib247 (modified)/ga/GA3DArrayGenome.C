...
GA3DArrayGenome<T>(w,h,d,f,u) {
  ...
  aset[0] = s;
    ...
    GA3DArrayAlleleGenome<T>::initializer(GA3DArrayAlleleGenome<T>::DEFAULT_3DARRAY_ALLELE_INITIALIZER);
    GA3DArrayAlleleGenome<T>::mutator(GA3DArrayAlleleGenome<T>::DEFAULT_3DARRAY_ALLELE_MUTATOR);
