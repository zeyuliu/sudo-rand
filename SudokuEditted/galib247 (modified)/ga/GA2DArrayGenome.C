...
GA2DArrayGenome<T>(width,height,f,u){
  ...
  aset[0] = s;
    ...
    GA2DArrayAlleleGenome<T>::initializer(GA2DArrayAlleleGenome<T>::DEFAULT_2DARRAY_ALLELE_INITIALIZER);
    GA2DArrayAlleleGenome<T>::mutator(GA2DArrayAlleleGenome<T>::DEFAULT_2DARRAY_ALLELE_MUTATOR);
