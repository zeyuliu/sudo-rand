...
GA1DArrayGenome(unsigned int in_length, GAGenome::Evaluator f, void * u) :
//GAArray<T>(length),
GAArray<T>(in_length),
...
GA1DArrayGenome<T>(length, f, u){
  ...
  GA1DArrayAlleleGenome<T>::mutator(GA1DArrayAlleleGenome<T>::DEFAULT_1DARRAY_ALLELE_MUTATOR);
